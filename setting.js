...
global.nomerOwner ="6287834993722"
global.nomerOwner2 = "6281329411749"
global.ownerName = "NathanXD"
global.namabot = "Hecate II"
global.botName = "Hecate II"
global.autoJoin = true
global.sessionName = 'session' //hati hati nanti error
global.packName = "NEET"
global.authorName = "Hecate II"
global.namastore = "NatXD Store"
global.nodana = "081329411749"
global.nogopay = "081329411749"
global.noovo = "087834993722"
global.qris = "-"
global.TextT = `Hecate II` //
global.textT = `Hecate II` // 

global.sgc = 'https://discord.com/invite/6Q49HnEV'
global.syt = '-'
global.sig = 'https://instagram.com/nathan_xd39'
const mess = {
wait: '`</> L O A D I N G </>`',
query: '`</> I N P U T  Q U E R Y </>`',
search: '`</> S E A R C H I N G </>`',
scrap: '`</> S C R A P P I N G </>`',
success: '`</> S U C C E S S </>`',
err: '`</> E R R O R </>`',
limit: '`</> N O T  E N O U G H T  L I M I T </>`',
claimOn: '`</> H A S  R E A C H  D A I L Y  C L A I M </>` ',
wrongFormat: '`</> W R O N G  F O R M A T </>`',

error: {
stick: '`</> N O T  S T I C K E R </>`',
api: '`</> A P I  E R R O R </>`',
Iv: '`</> L I N K  E R R O R </>`',
link : "`</> L I N K  E R R O R </>`"
},
block:{
Bowner: `C O M M A N D  B E I N G  R E P A I R E D`,
Bsystem: `C O M M A N D  H A S  B E E N  B L O C K E D`
},
only: {
prem : '`</> P R E M I U M  O N L Y </>`',
group: '`</> G R O U P  O N L Y </>`',
ownerB: '`</> O W N E R  B O T  O N L Y </>`',
owner: '`</> O W N E R  O N L Y </>`',
admin: '`</> A D M I N  O N L Y </>`',
Badmin: '`</> B O T  M U S T  B E  A D M I N </>`'
}
